...
/**
 * @brief Compute aggregate stats for a character by summing class, genetics, and veterancy.
...
/**
 * @brief Allocate and initialize a character from a specific UnitClass template.
 * @param owner Owning faction for the character.
 * @param sprite Sprite texture for the character.
...
/**
 * @brief Initialize a Character as a militia: set class, random genetics, and default skills.
...
/**
 * @brief Initialize a Character as a warg: set class, random genetics, and default skills.
 * @param character Character to initialize (NULL-safe via NULL_CHECK_VOID).
 * @param owner Owning faction for the character.
 * @param sprite Sprite texture for the character.
 */
...
/**
 * @brief Apply damage to a character and clamp health to zero; print defeat message on death.
...
/**
 * @brief Apply experience to the character and mark a pending level-up if threshold reached.
...
/**
 * @brief Perform an immediate level-up: increase veterancy bonuses, heal, and set next-level XP.
...
/**
 * @brief Allocate and initialize an array of characters from a UnitClass template.
